...
class TestResolveEmbeddingConfig:
    ...
    def _resolve(self, **kwargs):
        from houyi_studio.server.rag_service import resolve_embedding_config
...
class TestAutoDetectEmbedding:
    ...
    def _auto_detect(self):
        from houyi_studio.server.rag_service import _auto_detect_embedding
...
class TestProviderDefaults:
    ...
    def _make(self, provider, model=None, dimension=None):
        from houyi_studio.server.rag_service import _make_embedding_config
