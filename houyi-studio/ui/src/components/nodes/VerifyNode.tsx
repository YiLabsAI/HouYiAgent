...
export const VerifyNode = memo(({ data, selected, id }: NodeProps) => {
    ...
    <div className={`px-4 py-2 shadow-lg rounded-md border-2 ${config.bg} ${config.border} ${
      ...
      <div className="flex items-center gap-2">
        ...
        <div className="flex-1">
          <div className={`text-sm font-bold ${config.text}`}>{data.label || 'Verify'}</div>
          <div className="text-xs text-gray-600">Verify Node</div>
        </div>
