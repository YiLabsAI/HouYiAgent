...
interface BottomPanelProps {
  ...
  activeTab?: 'timeline' | 'checkpoints' | 'context' | 'logs' | 'verification' | 'compare' | 'knowledge';
  onTabChange?: (
    tab: 'timeline' | 'checkpoints' | 'context' | 'logs' | 'verification' | 'compare' | 'knowledge',
  ) => void;
}

type TabType = 'timeline' | 'checkpoints' | 'context' | 'logs' | 'verification' | 'compare' | 'knowledge';
