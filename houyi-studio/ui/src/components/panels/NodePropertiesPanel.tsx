/**
 * Node Properties panel for the Secondary Sidebar.
 *
 * Displays config, prompt, inputs, outputs, verification, and metadata tabs
 * for the currently selected DAG node. Extracted from the monolithic
 * RightSidebar to support multi-mode content routing.
 */
              ...
              <>
                ...
                <div className="border-t border-gray-700 pt-3 space-y-2">
                  ...
                  <div className="text-[10px] text-gray-500">
                    Eval results will surface in Logs, plus upcoming score dashboards.
                  </div>
                </div>
