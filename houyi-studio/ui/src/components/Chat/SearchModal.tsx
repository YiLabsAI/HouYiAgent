...
import { Search, X, MessageSquare, FileText, ArrowLeft, Bookmark } from 'lucide-react';
    ...
    <>
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto">
          {loading && (
            <div className="px-4 py-3 text-[12px] text-gray-500 animate-pulse">Searching...</div>
          )}
