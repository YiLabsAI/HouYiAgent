...
4 core evaluators (Accuracy, Cost, Latency, SkillUsage)
6 additional evaluators (Completeness, Relevance, Toxicity, Hallucination, SemanticSimilarity, LLMJudge)
9 advanced evaluators (Bias, Safety, Factuality, Groundedness, Coherence, ContextPrecision, ContextRecall, Faithfulness, CustomEvaluator)
"""
...
from houyi.assurance.evaluation.base import EvaluationResult, Evaluator
...
Respond in format: SCORE: <number> | FEEDBACK: <text>"""
                ...
                logger.warning("LLM Judge failed: %s, using heuristics", e)
