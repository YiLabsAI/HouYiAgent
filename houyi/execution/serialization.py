...
def to_wire_data(value: Any, *, by_alias: bool = True) -> Any:
    """Convert mixed model objects into plain JSON-friendly Python structures.

    Supports Pydantic-like objects exposing ``model_dump`` and stdlib dataclasses,
    recursively handling nested dict/list/tuple/set containers.
    """
