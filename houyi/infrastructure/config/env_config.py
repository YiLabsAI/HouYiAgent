...
ENV_WEB_SEARCH_CACHE_MIN_RESULTS = "WEB_SEARCH_CACHE_MIN_RESULTS"
ENV_WEB_SEARCH_PROXY_POLICY = "WEB_SEARCH_PROXY_POLICY"
...
ENV_SHELL_CURL_TIMEOUT = "HOUYI_SHELL_CURL_TIMEOUT"
