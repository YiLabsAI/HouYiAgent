...
class TestCoreGuardDecisions:
    ...
    def test_non_ext_always_allowed(self) -> None:
    ...
    def test_ext_exec_denied(self) -> None:
    ...
    def test_ext_fs_write_denied(self) -> None:
    ...
    def test_ext_fs_read_consent(self) -> None:
    ...
    def test_ext_network_allowed(self) -> None:
    ...
    def test_ext_no_side_effect(self) -> None:
    ...
    def test_ext_none_side_effect(self) -> None:
    ...
    def test_deny_contains_tool_name(self) -> None:
    ...
    def test_result_allowed_property(self) -> None:
