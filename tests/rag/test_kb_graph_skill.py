...
class TestExecuteKBGraph:
    ...
    async def test_execute_success(self) -> None:
        ...
        with patch("houyi.rag.RAG", return_value=mock_rag):
            input_data = KBGraphInput(query="find Alice")
    ...
    @pytest.mark.asyncio
    async def test_execute_with_start_entities(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_execute_multiple_entities(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_execute_ppr_disabled(self) -> None:
